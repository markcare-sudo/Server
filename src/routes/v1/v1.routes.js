...
router.use("/orders", require("../../modules/control-panel/orders/order.routes"));
router.use("/service-bookings", require("../../modules/control-panel/serviceBooking/serviceBooking.routes"));
